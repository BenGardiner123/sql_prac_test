...
('BRICK_101', 'Basic Bricklaying'),
('CARPENTRY_102', 'Basic Carpentry'),
('PLUMBING_103', 'How to fix your toilet');

INSERT INTO COURSE_OFFERING (WarehouseLocation, CourseID, CourseDate) VALUES
('OAKLIEGH','BRICK_101','2020-06-15'),
('SKYE','CARPENTRY_102', '2020-06-15'), 
('DANDENONG','PLUMBING_103', '2020-06-15');

INSERT INTO BOOKING (CustomerID, WarehouseLocation, CourseID, CourseDate, BookingDate, PaymentAmount, Review) VALUES
('193840923847', 'Oakleigh', 'BRICK_101', '2020-06-15', '2020-03-15', '500.00', NULL),
('193834923847', 'Skye', 'CARPENTRY_102', '2020-06-15', '2020-03-32', '400.00', NULL),
('134403563847', 'Dandenong', 'PLUMBING_103', '2020-06-15', '2020-03-23', '600.00', 'This course was amazing i especiialy like the instructor Toni');

INSERT INTO STAFF_ALLOCATION (StaffID, CourseDate, WarehouseLocation, CourseID) VALUES
('10000212','2020-06-15','OAKLIEGH', 'BRICK_101'),
('10000213', '2020-06-15', 'SKYE', 'CARPENTRY_102'),
('10000214','2020-06-15','DANDENONG','PLUMBING_103');  
