...
-- DATA RETURNED MATCHES

SELECT *
FROM ENROLMENT
SELECT COUNT(*)
FROM ENROLMENT;
-- 10 ENROLEMENTS MATCHES RETURN FRO QUERY */
...
-- WHEN I EXECUTE THESE TOGETHER THEY DONT SHOW THE SUBJECT COUNT* ONWARDS
-- HOWEVER WHEN I RUN THEM 1 BU ONE THEY WORK? ANYWAYS IT CONFIRMS THAT THE RESULTS LOOK GOOD.
